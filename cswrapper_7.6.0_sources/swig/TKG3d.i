...
WRAP_AS_NCOLLECTION_INCLUDE(TColGeom_Array2OfSurface,NCollection_Array2,Handle(Geom_Surface))
...
WRAP_AS_NCOLLECTION_INCLUDE(TColGeom_Array2OfBezierSurface,NCollection_Array2,Handle(Geom_BezierSurface))
