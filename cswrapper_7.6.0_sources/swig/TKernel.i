...
WRAP_AS_EXCEPTION(Standard_TooManyUsers)
...
WRAP_AS_EXCEPTION(OSD_Exception_FLT_DENORMAL_OPERAND)
WRAP_AS_EXCEPTION(OSD_Exception_FLT_DIVIDE_BY_ZERO)
WRAP_AS_EXCEPTION(OSD_Exception_FLT_INEXACT_RESULT)
WRAP_AS_EXCEPTION(OSD_Exception_FLT_INVALID_OPERATION)
WRAP_AS_EXCEPTION(OSD_Exception_FLT_OVERFLOW)
WRAP_AS_EXCEPTION(OSD_Exception_FLT_STACK_CHECK)
WRAP_AS_EXCEPTION(OSD_Exception_FLT_UNDERFLOW)
WRAP_AS_EXCEPTION(OSD_Exception_ILLEGAL_INSTRUCTION)
WRAP_AS_EXCEPTION(OSD_Exception_INT_DIVIDE_BY_ZERO)
...
%}
WRAP_INCLUDE(NCollection_DefaultHasher)
...
%warnfilter(SWIGWARN_PARSE_NAMED_NESTED_CLASS) NCollection_Vector::Iterator;
WRAP_INCLUDE(NCollection_Vector)
...
WRAP_AS_NCOLLECTION_INCLUDE(TColStd_Array2OfInteger,NCollection_Array2,Standard_Integer)
WRAP_AS_HANDLE_INCLUDE(TColStd_HArray2OfInteger)
WRAP_AS_NCOLLECTION_INCLUDE(TColStd_Array2OfReal,NCollection_Array2,Standard_Real)
WRAP_AS_HANDLE_INCLUDE(TColStd_HArray2OfReal)
WRAP_AS_NCOLLECTION_INCLUDE(TColStd_Array2OfBoolean,NCollection_Array2,Standard_Boolean)
WRAP_AS_HANDLE_INCLUDE(TColStd_HArray2OfBoolean)
WRAP_AS_NCOLLECTION_INCLUDE(TColStd_Array2OfTransient,NCollection_Array2,Handle(Standard_Transient))
...
WRAP_AS_DATAMAP_INCLUDE(TColStd_IndexedDataMapOfStringString,NCollection_IndexedDataMap,TCollection_AsciiString,TCollection_AsciiString,TCollection_AsciiString)

%{ #include <TColStd_MapTransientHasher.hxx> %}
WRAP_AS_MAP_INCLUDE(TColStd_MapOfTransient,NCollection_Map,Handle(Standard_Transient),TColStd_MapTransientHasher)
WRAP_AS_DATAMAP_INCLUDE(TColStd_IndexedDataMapOfTransientTransient,NCollection_IndexedDataMap,Handle(Standard_Transient),Handle(Standard_Transient),TColStd_MapTransientHasher)
