...
WRAP_AS_HANDLE(TopLoc_Datum3D)
WRAP_INCLUDE(TopLoc_Datum3D) 
...
WRAP_AS_HANDLE_INCLUDE(Graphic3d_Texture2Dmanual)
...
WRAP_AS_HANDLE_INCLUDE(Graphic3d_ArrayOfTriangles)
...
WRAP_AS_HANDLE(Prs3d_PresentationShadow)
WRAP_INCLUDE(Prs3d_PresentationShadow)
...
WRAP_AS_HANDLE_INCLUDE(AIS_Manipulator)
#endif
