...
WRAP_AS_MAP_INCLUDE(TDF_LabelMap,NCollection_Map,TDF_Label,TDF_LabelMapHasher)
WRAP_AS_DATAMAP_INCLUDE(TDF_LabelDataMap,NCollection_DataMap,TDF_Label,TDF_Label,TDF_LabelMapHasher)
...
WRAP_AS_MAP_INCLUDE(TDF_AttributeMap,NCollection_Map,Handle(TDF_Attribute),TColStd_MapTransientHasher)
WRAP_AS_DATAMAP_INCLUDE(TDF_AttributeDataMap,NCollection_DataMap,Handle(TDF_Attribute),Handle(TDF_Attribute),TColStd_MapTransientHasher)
