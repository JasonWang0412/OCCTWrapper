...
WRAP_AS_MAP_INCLUDE(BOPDS_MapOfPaveBlock,NCollection_Map,Handle(BOPDS_PaveBlock),TColStd_MapTransientHasher)
WRAP_AS_MAP_INCLUDE(BOPDS_IndexedMapOfPaveBlock,NCollection_IndexedMap,Handle(BOPDS_PaveBlock),TColStd_MapTransientHasher)
...
// BOPTools
WRAP_AS_CLASS_INCLUDE(BOPTools_AlgoTools3D)