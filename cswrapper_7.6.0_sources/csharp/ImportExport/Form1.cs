	...
	public class Form1 : System.Windows.Forms.Form
	{
      ...
      this.PerformLayout();
		...
		public void SelectionChanged()
		{
			...
			this.HlrOff.Pushed=!curForm.HlrMode;
			this.HlrOn.Pushed=curForm.HlrMode;

			this.ZoomWin.Pushed = curForm.Mode == OCCWinForms.CurrentAction3d.CurAction3d_WindowZooming;
			this.ZoomProg.Pushed = curForm.Mode == OCCWinForms.CurrentAction3d.CurAction3d_DynamicZooming;
			this.Pan.Pushed = curForm.Mode == OCCWinForms.CurrentAction3d.CurAction3d_DynamicPanning;
			this.Rot.Pushed = curForm.Mode == OCCWinForms.CurrentAction3d.CurAction3d_DynamicRotation;
		}
    ...
    private void toolBarView_ButtonClick(object sender, System.Windows.Forms.ToolBarButtonClickEventArgs e)
    {
      ...
      switch(toolBarView.Buttons.IndexOf(e.Button))
      {
        case 0:
          ...
          break;
        case 1:
          curForm.Mode = OCCWinForms.CurrentAction3d.CurAction3d_WindowZooming;
          this.ZoomWin.Pushed=true;
          break;
        case 2:
          curForm.Mode = OCCWinForms.CurrentAction3d.CurAction3d_DynamicZooming;
          this.ZoomProg.Pushed=true;
          break;
        case 3:
          curForm.Mode = OCCWinForms.CurrentAction3d.CurAction3d_DynamicPanning;
          this.Pan.Pushed=true;
          break;
        case 4:
        ...
        case 10:
          ...
          break;
        case 11:
          curForm.Mode = OCCWinForms.CurrentAction3d.CurAction3d_DynamicRotation;
          this.Rot.Pushed=true;
          break;
        case 12:
          curForm.View.ResetView();
          break;
        case 13:
          // curForm.View.SetHlrModeOn();
          curForm.HlrMode=true;
          this.HlrOff.Pushed=false;
          this.HlrOn.Pushed=true;
          break;
        case 14:
          // curForm.View.SetHlrModeOff();
          curForm.HlrMode=false;
